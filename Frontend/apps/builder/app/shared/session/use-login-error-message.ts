...
export const LOGIN_ERROR_MESSAGES = {
  ...
  [AUTH_PROVIDERS.LOGIN_PASSWORD]:
    "There has been an issue logging you in with email and password",
  [AUTH_PROVIDERS.REGISTER_PASSWORD]:
    "There has been an issue creating your account",
};
  ...
  useEffect(() => {
    ...
    switch (error) {
      ...
      case AUTH_PROVIDERS.LOGIN_PASSWORD:
        setMessageToReturn(LOGIN_ERROR_MESSAGES[AUTH_PROVIDERS.LOGIN_PASSWORD]);
        break;
      case AUTH_PROVIDERS.REGISTER_PASSWORD:
        setMessageToReturn(
          LOGIN_ERROR_MESSAGES[AUTH_PROVIDERS.REGISTER_PASSWORD]
        );
        break;
