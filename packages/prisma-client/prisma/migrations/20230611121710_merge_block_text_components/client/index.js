...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\kondk\\OneDrive\\Desktop\\Projects\\BZTech\\webStudio\\webstudio\\packages\\prisma-client\\prisma\\migrations\\20230611121710_merge_block_text_components\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "2d66ad397e5965d68d109ff05f6ee6ba589ec793183931cbf4e77ae87bfeb97a",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "migrations/20230611121710_merge_block_text_components/client",
    "20230611121710_merge_block_text_components/client",
  ]
...
path.join(process.cwd(), "migrations/20230611121710_merge_block_text_components/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "migrations/20230611121710_merge_block_text_components/client/schema.prisma")
