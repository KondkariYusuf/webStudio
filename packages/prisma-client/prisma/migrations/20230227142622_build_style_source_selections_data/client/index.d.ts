...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'team' | 'asset' | 'user' | 'project' | 'build' | 'tree' | 'breakpoints' | 'authorizationToken' | 'dashboardProject'
  ...
  export type TreeWhereUniqueInput = Prisma.AtLeast<{
    id_projectId?: TreeIdProjectIdCompoundUniqueInput
    AND?: TreeWhereInput | TreeWhereInput[]
    OR?: TreeWhereInput[]
    NOT?: TreeWhereInput | TreeWhereInput[]
    id?: StringFilter<"Tree"> | string
  ...
  export type TreeIdProjectIdCompoundUniqueInput = {
    id: string
    projectId: string
  }
