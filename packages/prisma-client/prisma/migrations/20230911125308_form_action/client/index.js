...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\kondk\\OneDrive\\Desktop\\Projects\\BZTech\\webStudio\\webstudio\\packages\\prisma-client\\prisma\\migrations\\20230911125308_form_action\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "7542ac46d1bc7ce171bd164cdc33c0580a0b5e2191ad3f24cc41faf4adb6d136",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "migrations/20230911125308_form_action/client",
    "20230911125308_form_action/client",
  ]
...
path.join(process.cwd(), "migrations/20230911125308_form_action/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "migrations/20230911125308_form_action/client/schema.prisma")
