...
export const color = {
  ...
  backgroundSpacingTopBottom: "#f4f4f4",
  backgroundSpacingLeftRight: "#f4f4f4",
  ...
  backgroundCanvas: "#f6f7ed",
  backgroundTopbar: "#1f1f1f",
