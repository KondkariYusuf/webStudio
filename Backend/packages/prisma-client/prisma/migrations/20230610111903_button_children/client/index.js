...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\kondk\\OneDrive\\Desktop\\Projects\\BZTech\\webStudio\\webstudio\\packages\\prisma-client\\prisma\\migrations\\20230610111903_button_children\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "migrations/20230610111903_button_children/client",
    "20230610111903_button_children/client",
  ]
...
path.join(process.cwd(), "migrations/20230610111903_button_children/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "migrations/20230610111903_button_children/client/schema.prisma")
