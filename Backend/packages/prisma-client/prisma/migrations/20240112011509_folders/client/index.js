...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\kondk\\OneDrive\\Desktop\\Projects\\BZTech\\webStudio\\webstudio\\packages\\prisma-client\\prisma\\migrations\\20240112011509_folders\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "e6f9e7d44917215b0a4718b8d0eda2e647292221f563a637c744fadd57fea29f",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "migrations/20240112011509_folders/client",
    "20240112011509_folders/client",
  ]
...
path.join(process.cwd(), "migrations/20240112011509_folders/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "migrations/20240112011509_folders/client/schema.prisma")
