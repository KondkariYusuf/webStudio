...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'team' | 'file' | 'asset' | 'user' | 'clientReferences' | 'product' | 'transactionLog' | 'project' | 'build' | 'authorizationToken' | 'domain' | 'projectDomain' | 'userProduct' | 'projectWithDomain' | 'latestBuildPerProjectDomain' | 'latestBuildPerProject' | 'dashboardProject'
  ...
  export type TransactionLogWhereInput = {
    ...
    userId?: StringFilter<"TransactionLog"> | string
  ...
  export type TransactionLogScalarWhereWithAggregatesInput = {
    ...
    userId?: StringWithAggregatesFilter<"TransactionLog"> | string
