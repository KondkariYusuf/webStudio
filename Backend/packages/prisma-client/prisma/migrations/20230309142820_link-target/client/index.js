...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\kondk\\OneDrive\\Desktop\\Projects\\BZTech\\webStudio\\webstudio\\packages\\prisma-client\\prisma\\migrations\\20230309142820_link-target\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "migrations/20230309142820_link-target/client",
    "20230309142820_link-target/client",
  ]
...
path.join(process.cwd(), "migrations/20230309142820_link-target/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "migrations/20230309142820_link-target/client/schema.prisma")
