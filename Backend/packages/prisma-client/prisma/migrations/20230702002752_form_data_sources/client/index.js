...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "migrations/20230702002752_form_data_sources/client",
    "20230702002752_form_data_sources/client",
  ]
...
path.join(process.cwd(), "migrations/20230702002752_form_data_sources/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "migrations/20230702002752_form_data_sources/client/schema.prisma")
