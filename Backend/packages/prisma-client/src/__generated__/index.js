...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    ...
    "prisma-client/src/__generated__",
  ]
...
path.join(process.cwd(), "packages/prisma-client/src/__generated__/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "packages/prisma-client/src/__generated__/schema.prisma")
