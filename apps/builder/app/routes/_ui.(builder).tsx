...
export const loader = async (loaderArgs: LoaderFunctionArgs) => {
  ...
  try {
    ...
    const httpBuilderOrigin = `http://${url.host}`;
    const httpsBuilderOrigin = `https://${url.host}`;
    ...
    headers.set(
      ...
      `frame-src ${httpBuilderOrigin} ${httpsBuilderOrigin} https://app.goentri.com/ https://help.webstudio.is/; worker-src 'none'`
    );
